...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor tpInstructor = new Instructor("Pulkit","Singh","td@ref.com");
			InstructorDetail tpInstructorDetail =new InstructorDetail("www.codegyan.com","codinggg");
			...
			InstructorDetail pInstructorDetail =new InstructorDetail("www.pintugyan.com","khana");
			
			tpInstructor.setInstructorDetail(tpInstructorDetail);
